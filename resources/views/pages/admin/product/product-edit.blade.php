                            ...
                            @if($product->category == 'pizza')
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="additionalProperties[variant]"
                                        ...
                                        <option
                                            {{$product->additionalProperties['variant'] === 'flavors of the world' ? 'selected': ''}} value="flavors of the world">
                                            Flavors Of The World
                                        </option>
                                        <option
                                            {{$product->additionalProperties['variant'] === 'supper topping' ? 'selected': ''}} value="supper topping">
                                            Supper Topping
                                        </option>
                                        <option
                                            {{$product->additionalProperties['variant'] === 'seafood cravers' ? 'selected': ''}} value="seafood cravers">
                                            Seafood Cravers
                                        </option>
                                        <option
                                            {{$product->additionalProperties['variant'] === 'traditional & meatlovers' ? 'selected': ''}} value="traditional & meatlovers">
                                            Traditional & Meatlovers
                                        </option>
                                        <option
                                            {{$product->additionalProperties['variant'] === 'kid favors' ? 'selected': ''}} value="kid favors">
                                            Kid Favors
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="additionalProperties[topping]"
                                            ...
                                            required>
                                        <option
                                            {{$product->additionalProperties['topping'] === 'Seafood' ? 'selected': ''}} value="Seafood">
                                            Seafood
                                        </option>
                                        <option
                                            {{$product->additionalProperties['topping'] === 'Beef' ? 'selected': ''}} value="Beef">
                                            Beef
                                        </option>
                                        <option
                                            {{$product->additionalProperties['topping'] === 'Chicken' ? 'selected': ''}} value="Chicken">
                                            Chicken
                                        </option>
                                        <option
                                            {{$product->additionalProperties['topping'] === 'Pork' ? 'selected': ''}} value="Pork">
                                            Pork
                                        </option>
                                        <option
                                            {{$product->additionalProperties['topping'] === 'Vegetarian' ? 'selected': ''}} value="Vegetarian">
                                            Vegetarian
                                        </option>
                                    </select>
                                </div>
                            ...
                            @if($product->category == 'side')
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="additionalProperties[variant]"
                                            name="additionalProperties[variant]" required>
                                        <option
                                            {{$product->additionalProperties['variant'] === 'Potato' ? 'selected': ''}} value="Potato">
                                            Potato
                                        </option>
                                        <option
                                            {{$product->additionalProperties['variant'] === 'Chicken' ? 'selected': ''}} value="Chicken">
                                            Chicken
                                        </option>
                                        <option
                                            {{$product->additionalProperties['variant'] === 'Spaghetti' ? 'selected': ''}} value="Spaghetti">
                                            Spaghetti
                                        </option>
                                        <option
                                            {{$product->additionalProperties['variant'] === 'Sausage' ? 'selected': ''}} value="Sausage">
                                            Sausage
                                        </option>
                                        <option
                                            {{$product->additionalProperties['variant'] === 'Bread' ? 'selected': ''}} value="Bread">
                                            Bread
                                        </option>
                                    </select>
                                </div>
