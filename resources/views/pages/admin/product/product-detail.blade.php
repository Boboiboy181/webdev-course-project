            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <p>Price:
                            <span
                                class="font-weight-bold">{{ number_format($product->price, 0, ',', ',') }} VNĐ
                            </span>
                        </p>
                        <p>Category:
                            <span
                                class="font-weight-bold">{{$product->category}}
                            </span>
                        </p>
                        @if($product->category == 'pizza' || $product->category == 'side')
                            <p>Variant:
                                <span
                                    class="font-weight-bold">{{$product->additionalProperties['variant']}}
                                </span>
                            </p>
                            <p>Topping:
                                <span
                                    class="font-weight-bold">{{$product->additionalProperties['topping']}}
                                </span>
                            </p>
                        @endif
                        <p>Description:
                            <span
                                class="font-weight-bold">{{$product->desc}}
                            </span>
                        </p>
                        <div>
                            <a href="{{route('admin.product.edit', ['id' => $product->_id])}}" class="btn btn-warning">Edit</a>
