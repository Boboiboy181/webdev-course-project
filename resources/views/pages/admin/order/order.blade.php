        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <x-table
                    ...
                    :field3="'Total Price'"
                    :field4="'Order Status'"
                    :field5="'Payment Status'"
                >
                    @foreach ($orders as $order)
                        <x-table-row
                            :data1="$order->order_code"
                            :data2="$order->customer['name']"
                            :data3="$order->total_price"
                            :data4="$order->status"
                            :data5="$order->payment_status"
                            :detailUrl="route('admin.order.detail', ['id' => $order->_id])"
                        />
                    @endforeach
                </x-table>
            </div>
